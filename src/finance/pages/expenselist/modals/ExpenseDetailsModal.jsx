...
export default function ExpenseDetailsModal({ isReceipt, isOpen, expense, onClose }) {
  return (
    <FinanceModal isOpen={isOpen} title="Detalhamento do valor" onClose={onClose}>
      <div className="expense-modal__details-card">
        <span>{isReceipt ? "Valor total do recebimento" : "Valor total da despesa"}</span>
      ...
      <dl className="expense-modal__details-list">
        ...
        <div><dt>{isReceipt ? "Cliente" : "Favorecido"}</dt><dd>{expense?.payee}</dd></div>
