...
import PedidosListPage from "./home/pages/orders/OrdersListPage.jsx";
              ...
              <Route
                ...
                element={
                  <SectionPage
                    ...
                    title="Serviços"
                    description="Área demonstrativa para a futura navegação do módulo de serviços."
                    ctaLabel="Voltar ao painel"
                    ctaPath="/dashboard"
                  />
                }
              ...
              <Route
                ...
                element={
                  <SectionPage
                    ...
                    title="Novo Item"
                    description="Ainda não existe uma tela dedicada para cadastro de itens no estoque. Esta rota permanece como placeholder."
                    ctaLabel="Voltar ao painel"
                    ctaPath="/dashboard"
                  />
                }
              ...
              <Route
                ...
                element={
                  <SectionPage
                    eyebrow="Organização"
                    title="Calendário"
                    description="Visualize a agenda e a disponibilidade da equipe técnica."
                    ctaLabel="Voltar ao painel"
                    ctaPath="/dashboard"
                  />
                }
              ...
              <Route
                ...
                element={
                  <SectionPage
                    ...
                    description="Central de ajuda e chamados de suporte ao sistema FaseCerta."
                    ctaLabel="Voltar ao painel"
                    ctaPath="/dashboard"
                  />
                }
